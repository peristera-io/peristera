# Contributing to Peristera Ergonomos

Thanks for your interest! A few things to know before you start.

## How we work

Peristera Ergonomos is developed with a specify → red → green → refactor (BDD) loop and
...
Before we can accept your contribution, you must agree to the Peristera Ergonomos
